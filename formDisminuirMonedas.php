...
if ($_SESSION['rol']!=2){
    header('Location: disminuirMonedas.php');
}
...
<body>
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            ?>   
    <form action="disminuirMonedas.php" method="post">
        ...
        <label for="Monedas_old">Cuantas monedas desea disminuir:</label>
